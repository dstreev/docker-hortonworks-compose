...
# Ambari Server
export AGENT=01
docker -H os10:2375 run -h ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core --privileged --network-alias ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core -P --name ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT} -d --network core --dns-search=core --restart=unless-stopped -e "AMBARI_VERSION=${AMBARI_VERSION}" -e "CLUSTER_PREFIX=${CLUSTER_PREFIX}" -e "AMBARI_INSTANCE=${AMBARI_INSTANCE}" -e "AMBARI_SERVER=true" -e "AGENT=${AGENT}" -e "REPO_BASE_URL=${REPO_BASE_URL}" -v "/var/local/hdp/${CLUSTER_PREFIX}${AMBARI_INSTANCE}/data:/data" dstreev/centos6_ambari:2

export AGENT=02
docker -H os11:2375 run -h ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core --privileged --network-alias ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core -P --name ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT} -d --network core --dns-search=core --restart=unless-stopped -e "AMBARI_VERSION=${AMBARI_VERSION}" -e "CLUSTER_PREFIX=${CLUSTER_PREFIX}" -e "AMBARI_INSTANCE=${AMBARI_INSTANCE}" -e "AMBARI_AGENT=true" -e "AGENT=${AGENT}" -e "REPO_BASE_URL=${REPO_BASE_URL}" -v "/var/local/hdp/${CLUSTER_PREFIX}${AMBARI_INSTANCE}/data:/data" dstreev/centos6_ambari:2

export AGENT=03
docker -H os12:2375 run -h ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core --privileged --network-alias ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core -P --name ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT} -d --network core --dns-search=core --restart=unless-stopped -e "AMBARI_VERSION=${AMBARI_VERSION}" -e "CLUSTER_PREFIX=${CLUSTER_PREFIX}" -e "AMBARI_INSTANCE=${AMBARI_INSTANCE}" -e "AMBARI_AGENT=true" -e "AGENT=${AGENT}" -e "REPO_BASE_URL=${REPO_BASE_URL}" -v "/var/local/hdp/${CLUSTER_PREFIX}${AMBARI_INSTANCE}/data:/data" dstreev/centos6_ambari:2

export AGENT=04
docker -H os13:2375 run -h ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core --privileged --network-alias ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core -P --name ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT} -d --network core --dns-search=core --restart=unless-stopped -e "AMBARI_VERSION=${AMBARI_VERSION}" -e "CLUSTER_PREFIX=${CLUSTER_PREFIX}" -e "AMBARI_INSTANCE=${AMBARI_INSTANCE}" -e "AMBARI_AGENT=true" -e "AGENT=${AGENT}" -e "REPO_BASE_URL=${REPO_BASE_URL}" -v "/var/local/hdp/${CLUSTER_PREFIX}${AMBARI_INSTANCE}/data:/data" dstreev/centos6_ambari:2

export AGENT=05
docker -H os14:2375 run -h ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core --privileged --network-alias ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core -P --name ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT} -d --network core --dns-search=core --restart=unless-stopped -e "AMBARI_VERSION=${AMBARI_VERSION}" -e "CLUSTER_PREFIX=${CLUSTER_PREFIX}" -e "AMBARI_INSTANCE=${AMBARI_INSTANCE}" -e "AMBARI_AGENT=true" -e "AGENT=${AGENT}" -e "REPO_BASE_URL=${REPO_BASE_URL}" -v "/var/local/hdp/${CLUSTER_PREFIX}${AMBARI_INSTANCE}/data:/data" dstreev/centos6_ambari:2

export AGENT=06
docker -H os15:2375 run -h ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core --privileged --network-alias ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT}.core -P --name ${CLUSTER_PREFIX}${AMBARI_INSTANCE}agent${AGENT} -d --network core --dns-search=core --restart=unless-stopped -e "AMBARI_VERSION=${AMBARI_VERSION}" -e "CLUSTER_PREFIX=${CLUSTER_PREFIX}" -e "AMBARI_INSTANCE=${AMBARI_INSTANCE}" -e "AMBARI_AGENT=true" -e "AGENT=${AGENT}" -e "REPO_BASE_URL=${REPO_BASE_URL}" -v "/var/local/hdp/${CLUSTER_PREFIX}${AMBARI_INSTANCE}/data:/data" dstreev/centos6_ambari:2
